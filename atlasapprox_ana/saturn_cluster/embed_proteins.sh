...
#PBS -l ngpus=1
#PBS -l mem=64GB
#PBS -o /srv/scratch/fabilab/fabio/projects/cell_atlas_approximations_analysis/logs/embed_peptides_output.log
#PBS -e /srv/scratch/fabilab/fabio/projects/cell_atlas_approximations_analysis/logs/embed_peptides_error.log
#PBS -j oe
#PBS -P MWAC
#PBS -l host=k099
#PBS -J 1-25
...
LOG_FILE="/srv/scratch/fabilab/fabio/projects/cell_atlas_approximations_analysis/logs/embed_peptides_output_$(date '+%Y-%m-%d_%H-%M-%S').log"
