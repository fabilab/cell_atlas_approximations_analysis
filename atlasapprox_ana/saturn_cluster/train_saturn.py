...
if __name__ == "__main__":
    ...
    fasta_root_folder = pathlib.Path("/srv/scratch/fabilab/fabio/projects/atlasapprox_saturn/data/reference_atlases/peptide_sequences/")
    ...
    output_fdn = embeddings_summary_fdn.parent / "saturn_output" / f"output_nmacro{args.n_macrogenes}_nhvg{args.n_hvg}_epochs_p{args.n_pretrain_epochs}_m{args.n_epochs}"
    if args.leaveout >= 1:
    ...
    # Run SATURN
    script_fn = pathlib.Path("/srv/scratch/fabilab/fabio/projects/atlasapprox_saturn") / "software" / "SATURN" / "train-saturn.py"
